...
void WriteRegisterModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        WriteRegisterModel *_t = static_cast<WriteRegisterModel *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (WriteRegisterModel::*_t)();
...
const QMetaObject WriteRegisterModel::staticMetaObject = {
    { &QAbstractTableModel::staticMetaObject, qt_meta_stringdata_WriteRegisterModel.data,
      qt_meta_data_WriteRegisterModel,  qt_static_metacall, nullptr, nullptr}
};
